...
WNBA球队十年收益预测（最终优化版）
核心修改：
1. 球员巅峰期调整为27-32岁，32岁后才下滑
2. 新增球员完整伤病史统计
3. 伤病概率分层控制（Clark 30% > 其他核心25% > 板凳5%），限制伤病人数避免球队瘫痪
4. 强化Clark伤病影响（能力/品牌/利润惩罚加倍），板凳球员影响降至最低
5. 控制参数幅度，保证结果与原版基本一致
"""
